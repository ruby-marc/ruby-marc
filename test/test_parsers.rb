...
class ParsersTest < MiniTest::Unit::TestCase
  ...
  def test_set_nokogiri
    begin
      ...
      reader = MARC::XMLReader.new('test/data/one.xml')
      assert_kind_of(REXML::Parsers::PullParser, reader.parser)
      reader = MARC::XMLReader.new('test/data/one.xml', :parser=>MARC::XMLReader::USE_NOKOGIRI)
      assert_kind_of(Nokogiri::XML::SAX::Parser, reader.parser)
      assert_equal("rexml", MARC::XMLReader.parser)
      reader = MARC::XMLReader.new('test/data/one.xml', :parser=>'nokogiri')
      assert_kind_of(Nokogiri::XML::SAX::Parser, reader.parser)
      assert_equal("rexml", MARC::XMLReader.parser)      
  ...
  def test_set_jrexml
    if defined? JRUBY_VERSION
      begin
        require 'jrexml'
        reader = MARC::XMLReader.new('test/data/one.xml', :parser=>MARC::XMLReader::USE_JREXML)
        assert_kind_of(REXML::Parsers::PullParser, reader.parser)
        assert_equal("rexml", MARC::XMLReader.parser)
        reader = MARC::XMLReader.new('test/data/one.xml', :parser=>'jrexml')
        assert_kind_of(REXML::Parsers::PullParser, reader.parser)
        assert_equal("rexml", MARC::XMLReader.parser)      
...
def test_set_jstax
  if defined? JRUBY_VERSION
    begin
      ...
      reader = MARC::XMLReader.new('test/data/one.xml', :parser=>MARC::XMLReader::USE_JSTAX)
      assert_kind_of(Java::ComSunOrgApacheXercesInternalImpl::XMLStreamReaderImpl, reader.parser)
      assert_equal("rexml", MARC::XMLReader.parser)
      reader = MARC::XMLReader.new('test/data/one.xml', :parser=>'jstax')
      assert_kind_of(Java::ComSunOrgApacheXercesInternalImpl::XMLStreamReaderImpl, reader.parser)
      assert_equal("rexml", MARC::XMLReader.parser)      
  ...
  def test_set_rexml
    reader = MARC::XMLReader.new('test/data/one.xml', :parser=>MARC::XMLReader::USE_REXML)
    assert_kind_of(REXML::Parsers::PullParser, reader.parser)
    assert_equal("rexml", MARC::XMLReader.parser)
    reader = MARC::XMLReader.new('test/data/one.xml', :parser=>'rexml')
    assert_kind_of(REXML::Parsers::PullParser, reader.parser)
    assert_equal("rexml", MARC::XMLReader.parser)      
  ...
  def test_set_magic
    ...
    reader = MARC::XMLReader.new('test/data/one.xml', :parser=>MARC::XMLReader::USE_BEST_AVAILABLE)
    assert_kind_of(magic_parser, reader.parser)
    assert_equal("rexml", MARC::XMLReader.parser)
    reader = MARC::XMLReader.new('test/data/one.xml', :parser=>'magic')
    assert_kind_of(magic_parser, reader.parser)
    assert_equal("rexml", MARC::XMLReader.parser)      
